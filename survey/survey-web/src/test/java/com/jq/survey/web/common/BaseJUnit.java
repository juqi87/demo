package com.jq.survey.web.common;
 ...
 * JUnit测试action时使用的基类
 * @author juqi
 * @version $Id: BaseJUnit.java, v 0.1 2016年6月20日 下午3:58:27 juqi Exp $
 */
public class BaseJUnit {
	...
	public static void setUp() {
		if (handlerMapping == null) {
			String[] configs = { "file:src/main/webapp/WEB-INF/applicationContext-mvc.xml" };
